...
public static class FileChunkingAuditLogEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE FileChunkingAuditLogModuleExtensionConfigurator CLASS (in the Domain.Shared project)
